...
$data = array();
    ...
    WHERE 
        tbl_form.firstname LIKE '%$search%' 
        OR tbl_form.lastname LIKE '%$search%'
        OR tbl_alumni.stud_no LIKE '%$search%'
        OR tbl_batch.batch LIKE '%$search%'
        OR tbl_program.course_abv LIKE '%$search%'
        OR tbl_form.current_title LIKE '%$search%'
        OR tbl_employment_status.status LIKE '%$search%'
        OR tbl_form.email LIKE '%$search%'
        OR tbl_form.contact LIKE '%$search%'
    ");
