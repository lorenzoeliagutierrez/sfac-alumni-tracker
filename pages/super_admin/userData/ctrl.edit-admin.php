...
if (isset($_POST['basic_info'])) {
  ...
  $updateInfo = mysqli_query($db, "UPDATE tbl_super_ad SET username='$username', firstname = '$firstname', lastname = '$lastname' WHERE admin_id = '$admin_id'") or die(mysqli_error($db));
